...
class RetrofitGeoQrApi(
    ...
    override suspend fun createQr(request: CreateQrRequest): String = service.createQr(request)
    override suspend fun resolveQr(qrId: String): String = service.resolveQr(qrId)
